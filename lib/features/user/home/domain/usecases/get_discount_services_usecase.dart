...
class GetDiscountServicesUseCase extends UseCase<List<DiscountServicesEntity>, String> {
  final UserRepo userRepo;

  GetDiscountServicesUseCase({required this.userRepo});

  @override
  Future<Either<Failure, List<DiscountServicesEntity>>> call(String?sort)async {

     final SharedPreferences prefs = await SharedPreferences.getInstance();
    final String? token = prefs.getString('token');

    return userRepo.getAllDiscountServices(
      sort: sort,
